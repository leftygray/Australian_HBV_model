...
project_name <- "Australia_HBV_estimates-BM-2"
...
# Create associated transitions and wiafw_matrix files -------------------
...
wiafw_matrix <- transitions

write_csv(transitions, file.path(projectFolder,
                               "population_transitions.csv"))

write_csv(wiafw_matrix, file.path(projectFolder,
                               "population_wiafw_matrix.csv"))
...
inputs <- list(initial_pops = initialPops, constants = constants,
               ...
               transitions = transitions, wiafw_matrix = wiafw_matrix)
